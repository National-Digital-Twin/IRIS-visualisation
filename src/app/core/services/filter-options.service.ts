...
export class FilterOptionsService {
  ...
  public readonly buildFormOptions = [
    'Detached',
    'Semi-Detached',
    'End-Terrace',
    'Mid-Terrace',
  ...
  public readonly wallInsulationOptions = [
    'NoInsulation',
    'FullyInsulated',
    'PartiallyInsulated',
    'AssumedLimitedInsulation',
    'NoData'
  ];

  public readonly floorConstructionOptions = [
    'SolidFloor',
    'SuspendedTimberFloor',
    'NoData'
  ];

  public readonly floorInsulationOptions = [
    'NoInsulation',
    'FullyInsulated',
    'PartiallyInsulated',
    'AssumedLimitedInsulation',
  ...
  public readonly roofConstructionOptions = [
    'FlatRoof',
    'PitchedRoof',
    'NoData'
  ];

  public readonly roofInsulationLocationOptions = [
    'NoInsulation',
    'CeilingLevel',
    'RafterLevel',
    'FlatRoofInsulation',
  ...
  public readonly roofInsulationThicknessOptions = [
    '0mm',
    '12mm',
    '25mm',
    '50mm',
  ...
  public readonly epcExpiryOptions = [
    'EPC In Date',
    'EPC Expired'
  ];
